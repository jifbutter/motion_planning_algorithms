'''slowbuildmap.py
   ...
   This "slow" version is meant for slow computers: It explicitly
   considers the timestamps, so it can properly connect data even if
   things are significantly slowed/delayed.
